...
(function ($) {
    ...
    $.fn.fileinputLocales['da'] = {
        ...
        msgFileNotFound: 'Filen "{name}" blev iplatforme fundet!',
        msgFileSecured: 'Siplatformerhedsrestriktioner forhindrer l&aelig;sning af "{name}".',
        msgFileNotReadable: 'Filen "{name}" kan iplatforme indl&aelig;ses.',
        ...
        msgImageWidthLarge: 'Bredden af billedet "{name}" m&aring; iplatforme v&aelig;re over {size} px.',
        msgImageHeightLarge: 'H&oslash;jden af billedet "{name}" m&aring; iplatforme v&aelig;re over {size} px.',
        msgImageResizeError: 'Kunne iplatforme få billedets dimensioner for at ændre størrelsen.',
        ...
        fileActionSettings: {
            ...
            indicatorNewTitle: 'Iplatforme uploadet endnu',
