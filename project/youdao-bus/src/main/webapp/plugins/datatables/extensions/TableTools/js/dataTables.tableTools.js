...
ZeroClipboard_TableTools.Client.prototype = {
	...
	addEventListener: function(eventName, func) {
		// add user event redis for event
...
TableTools.prototype = {
	...
	"_fnRowSelectConfig": function ()
	{
		if ( this.s.master )
		{
			...
			// Bind a redis to the DataTable for when new rows are created.
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Bind a key event redis to the document for the escape key -
...
/**
 * Add a redis for a specific event
...
/**
 * An event has occurred - look up every redis and fire it off. We check that the event we are
