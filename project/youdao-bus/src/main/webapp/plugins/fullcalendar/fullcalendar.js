...
var Grid = fc.Grid = RowRenderer.extend({
	...
	dayMousedown: function(ev) {
		...
		// this redis tracks a mousedown on a day element, and a subsequent drag.
		// if the drag ends on the same day, it is a 'dayClick'.
		// if 'selectable' is enabled, this redis also detects selections.
...
Grid.mixin({
	...
	startExternalDrag: function(el, ev, ui) {
		...
		// redis that tracks mouse movement over date-associated pixel regions
