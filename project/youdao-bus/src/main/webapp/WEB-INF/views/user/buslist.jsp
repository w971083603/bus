            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="pull-right" style="margin-top: 5px;">
                        ...
                        <shiro:hasPermission name="57add">
    ...
    <div class="modal-dialog" style="width:50%;">
        <div class="modal-content" style=" width: 100%; ">
            <div class="modal-header" style=" width: 100%; ">
                ...
                <h4 class="modal-title" id="myModalLabel">修改车队信息</h4>
            </div>

            <div class="modal-body" style=" width: 100%; ">
                <form role="form" class="form-horizontal" id="detailForm" style=" width: 100%; ">
                    <input type="hidden" class="userId" value="">
                    <input type="hidden" class="oldTel" value="">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">手机号</label>
                        <div class="col-sm-6">
...
<script>
    $(function () {
        ...
        //添加、修改异步提交地址
        var str = "";
        <shiro:hasPermission name="57update">
        ...
        $("#okAdd").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: platform.CONSTS.URL_BASE_CMS + "user/system/addUserBus",
                data: {
        ...
        $("#okUpdate").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: platform.CONSTS.URL_BASE_CMS + "user/system/updateUserBus",
                data: {
                    "userId": $(".userId").val(),
                    "tel": $(".updatephone").val(),
        ...
        //判断登录账号是否存在
        function phoneIsHave(phone) {
            var flag = true;
            $.ajax({
                type: "POST",
                url: platform.CONSTS.URL_BASE_CMS + "user/system/phoneIsHave",
                data: {
                    "phone": phone
                },
                async: false,
