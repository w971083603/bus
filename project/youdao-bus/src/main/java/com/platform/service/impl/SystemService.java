...
import com.platform.mapper.SystemMapper;
...
public class SystemService implements ISystemService {
    ...
    @Override
    public DatatablesResult<PageData> dataGridMessage(JSONObject params, Integer page, Integer rows, Integer draw) {
        PageHelper.startPage(page, rows);
        Map<String,String> whereMap = cmsUtil.toHashMap(params);
        List<PageData> userlistVos = this.systemMapper.dataGridMessage(whereMap);
    ...
    @Override
    public DatatablesResult<PageData> dataGridProblem(JSONObject params, Integer page, Integer rows, Integer draw) {
        PageHelper.startPage(page, rows);
        Map<String,String> whereMap = cmsUtil.toHashMap(params);
        List<PageData> userlistVos = this.systemMapper.dataGridProblem(whereMap);
        PageInfo<PageData> pageInfo = new PageInfo<PageData>(userlistVos);
        DatatablesResult pageResult = new DatatablesResult<PageData>();
        pageResult.setData(userlistVos);
        pageResult.setDraw(draw);
