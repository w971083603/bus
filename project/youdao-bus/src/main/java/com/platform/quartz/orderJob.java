...
public class orderJob {
    ...
    public void notifyJob() {
        ...
        for (PageData orderpd : list) {
            long createTime = DateUtil.fomatDate2(orderpd.get("createTime").toString()).getTime();
            if (nowTime - createTime > 5 * 1000) {
                //修改状态对超过5分钟未报价的订单系统提示后台管理介入人工处理
                String message =  "【有道巴士】" + "订单【"+orderpd.getString("orderUuid")+"】无人报价中,请前往处理";
                ...
                String message =  "【有道巴士】" + "订单【"+orderpd.getString("orderUuid")+"】正在报价中,请前往参加";
